...
class bcn_breadcrumb_trail {
    ...
    public function __construct() {
        ...
        $this->opt = array(
            ...
            'Hpaged_template' => sprintf('<span property="itemListElement" typeof="ListItem"><span property="name">%1$s</span><meta property="position" content="%%position%%"></span>', esc_attr__('Page %htitle%', 'muzzi-core')),
            ...
            'S404_title' => __('404', 'muzzi-core'),
            //Search page options
            //The breadcrumb template for search breadcrumbs
            'Hsearch_template' => sprintf('<span property="itemListElement" typeof="ListItem"><span property="name">%1$s</span><meta property="position" content="%%position%%"></span>', sprintf(esc_attr__('Search results for &#39;%1$s&#39;', 'muzzi-core'), sprintf('<a property="item" typeof="WebPage" title="%1$s" href="%%link%%" class="%%type%%">%%htitle%%</a>', esc_attr__('Go to the first page of search results for %title%.', 'muzzi-core')))),
            //The breadcrumb template for search breadcrumbs, used when an anchor is not necessary
            'Hsearch_template_no_anchor' => sprintf('<span property="itemListElement" typeof="ListItem"><span property="name">%1$s</span><meta property="position" content="%%position%%"></span>', sprintf(esc_attr__('Search results for &#39;%1$s&#39;', 'muzzi-core'), '%htitle%')),
            //Tag related stuff
            //The breadcrumb template for tag breadcrumbs
            'Htax_post_tag_template' => sprintf('<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="%1$s" href="%%link%%" class="%%type%%"><span property="name">%%htitle%%</span></a><meta property="position" content="%%position%%"></span>', esc_attr__('Go to the %title% tag archives.', 'muzzi-core')),
            ...
            'Htax_post_format_template' => sprintf('<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="%1$s" href="%%link%%" class="%%type%%"><span property="name">%%htitle%%</span></a><meta property="position" content="%%position%%"></span>', esc_attr__('Go to the %title% archives.', 'muzzi-core')),
            ...
            'Hauthor_template' => sprintf('<span property="itemListElement" typeof="ListItem"><span property="name">%1$s</span><meta property="position" content="%%position%%"></span>', sprintf(esc_attr__('Articles by: %1$s', 'breacrumb-navxt'), sprintf('<a title="%1$s" href="%%link%%" class="%%type%%">%%htitle%%</a>', esc_attr__('Go to the first page of posts by %title%.', 'muzzi-core')))),
            //The anchor template for author breadcrumbs, used when anchors are not needed
            'Hauthor_template_no_anchor' => sprintf('<span property="itemListElement" typeof="ListItem"><span property="name">%1$s</span><meta property="position" content="%%position%%"></span>', sprintf(esc_attr__('Articles by: %1$s', 'breacrumb-navxt'), '%htitle%')),
            ...
            'Htax_category_template' => sprintf('<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="%1$s" href="%%link%%" class="%%type%%"><span property="name">%%htitle%%</span></a><meta property="position" content="%%position%%"></span>', esc_attr__('Go to the %title% category archives.', 'muzzi-core')),
            ...
            'Hdate_template' => sprintf('<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="%1$s" href="%%link%%" class="%%type%%"><span property="name">%%htitle%%</span></a><meta property="position" content="%%position%%"></span>', esc_attr__('Go to the %title% archives.', 'muzzi-core')),
    ...
    protected function post_terms($id, $taxonomy) {
        ...
        if (is_array($bcn_terms)) {
            ...
            foreach ($bcn_terms as $term) {
                ...
                $title .= str_replace(
                        array('%title%', '%link%', '%htitle%', '%type%'), array($term->name, $this->maybe_add_post_type_arg(get_term_link($term), null, $term->taxonomy), $term->name, $term->taxonomy), $this->opt['Htax_' . $term->taxonomy . '_template']);
                $is_first = false;
            }
    ...
    protected function do_post($post, $force_link = false, $is_paged = false, $is_current_item = true) {
        ...
        if (!($post instanceof WP_Post)) {
            _doing_it_wrong(__CLASS__ . '::' . __FUNCTION__, __('$post global is not of type WP_Post', 'muzzi-core'), '5.1.1');
            return;
        }
    ...
    protected function do_day($post, $type, $is_paged = false, $is_current_item = true) {
        //Place the breadcrumb in the trail, uses the constructor to set the title, prefix, and suffix, get a pointer to it in return
        $breadcrumb = $this->add(new bcn_breadcrumb(get_the_time(_x('d', 'day archive breadcrumb date format', 'muzzi-core'), $post), $this->opt['Hdate_template_no_anchor'], array('archive', 'date-day')));
    ...
    protected function do_month($post, $type, $is_paged = false, $is_current_item = true) {
        //Place the breadcrumb in the trail, uses the constructor to set the title, prefix, and suffix, get a pointer to it in return
        $breadcrumb = $this->add(new bcn_breadcrumb(get_the_time(_x('F', 'month archive breadcrumb date format', 'muzzi-core'), $post), $this->opt['Hdate_template_no_anchor'], array('archive', 'date-month')));
    ...
    protected function do_year($post, $type, $is_paged = false, $is_current_item = true) {
        ...
        $breadcrumb = $this->add(new bcn_breadcrumb(get_the_time(_x('Y', 'year archive breadcrumb date format', 'muzzi-core'), $post), $this->opt['Hdate_template_no_anchor'], array('archive', 'date-year')));
    ...
    public function fill() {
        ...
        //For archives
            ...
            else if (is_post_type_archive() && !isset($type->taxonomy) && (!is_numeric($this->opt['apost_' . $type_str . '_root']) || $this->opt['bpost_' . $type_str . '_archive_display'])) {
