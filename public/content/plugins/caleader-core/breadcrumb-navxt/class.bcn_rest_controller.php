	...
	public function register_routes() {
		$this->register_rest_route(
			...
			array(
				'args'                => array(
					'id' => array(
						'description'       => __( 'The ID of the post (any type) to retrieve the breadcrumb trail for.', 'muzzi-core' ),
						'type'              => 'integer',
						'required'          => true,
		...
		$this->register_rest_route(
			...
			array(
				'args'     => array(
					'id'       => array(
						'description'       => __( 'The ID of the term to retrieve the breadcrumb trail for.', 'muzzi-core' ),
						'type'              => 'integer',
						'required'          => true,
						'validate_callback' => array( $this, 'validate_id' ),
					),
					'taxonomy' => array(
						'description'       => __( 'The taxonomy of the term to retrieve the breadcrumb trail for.', 'muzzi-core' ),
						'type'              => 'string',
						'required'          => true,
		...
		$this->register_rest_route(
			...
			array(
				'args'     => array(
					'id' => array(
						'description'       => __( 'The ID of the author to retrieve the breadcrumb trail for.', 'muzzi-core' ),
						'type'              => 'integer',
						'required'          => true,
						'validate_callback' => array( $this, 'validate_id' ),
					),
