...
<header id="tt-header" class="<?php echo esc_attr( $top_header_class ); ?>  tt-header-01">
	...
	<!-- panel-info -->
	<div class="tt-panel-info d-none">
		<div class="container">
	...
	<!-- header-holder -->
	<div class="header-holder d-flex">
		<div class="container align-self-center">
			<div class="row align-items-center no-gutters">
				...
				<div class="col-logo col-auto align-self-center">
				...
				<div class="col-search ml-5 d-none d-xl-block">
					<div class="input-group search_cars_wrapper">
						<input type="text" class="form-control" placeholder="Search Cars" aria-label="Search Cars" aria-describedby="basic-addon2"
							value="<?= isset($_GET['s'])? $_GET['s'] : '' ?>">
						<div class="input-group-append">
							<button id="search_cars" class="btn btn-primary btn-lg" type="button">Search</button>
						</div>						
					</div>					
				</div>
				...
				<!-- <div class="col-search d-none d-xl-block">
					<div class="input-group check_status_wrapper">
						<input type="text" class="form-control" placeholder="Reference Number" aria-label="Reference Number" aria-describedby="basic-addon2">
						<div class="input-group-append">
							<button id="check_status" class="btn btn-outline-primary btn-lg" type="button">Check Status</button>
						</div>						
					</div>
					<label id="check_status_response" class="badge bg-orange-400 text-orange-100" style="display: none;"><span class="bullet text-orange-200">&bull;</span> <span class="txt">Your loan status is</span> <strong>Pending</strong></label>
				</div> -->
				...
				<div class="col-btn-toggle-modal col-auto">
						...
						if ( $add_button_func == 'shortcode' ) {
							?>
									<a class="btn btn-toggle-modal d-none" href="<?php echo esc_js( 'javascript:void(0)' ); ?>"
						data-toggle="modal" data-target="#modalAddYourItem"><i class="icon-addcar"></i><span
							...
							?>
									<a class="btn btn-toggle-modal d-none" href="<?php echo esc_url( $add_button_url ); ?>"><i class="icon-addcar"></i><span
							class="tt-text"><?php echo esc_html__( 'add your item', 'caleader' ); ?></span>
						</a>
									<?php
						}
				...
				<?php } ?>
				<div class="col-menu-toggle col-auto align-self-center">
					<div id="nav-icon1" class="tt-menu-toggle icon-menu">
						<span></span>
						<span></span>
						<span></span>
					</div>				
